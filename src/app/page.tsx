      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
          ...
          <ul className="my-4 space-y-3">
            <li>
              <a
                href="https://open.spotify.com/playlist/4wMhdO2xQ038tzv6dMHsuo?si=C-kIv1lfQZu2KnKmq8IvAQ&pi=u-JbTXh1GsTHaA&fbclid=PAZXh0bgNhZW0CMTEAAabbw6nQr5bn90BNOUlOlbCDMJ9OtXINTrhcVPVjGdxsKat_NdIElZdLTr8_aem_BnKaLFBbpYObl_B1tKiy8Q&nd=1&dlsi=73037baac86e4eda"
            ...
            <li>
              <a
                href="https://github.com/EdreiFernandes?fbclid=PAZXh0bgNhZW0CMTEAAaaC4LEd6eg_zwYkmAsft0xj5fwvW30gqoWjvgt_kKapeRWCtZHTCGg5Hms_aem_K9eOGgjUprbGFLg-AaU2Og"
                className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <a
                href="https://edreifernandes.wixsite.com/nous?fbclid=PAZXh0bgNhZW0CMTEAAaZjEQkrlwWc_xK2dAhvoOQVelVMdyJPxwLoB22KjNcpkPL2hxPY99YWWsk_aem_8jyj4W1JqRTttuL9wF_0-g"
                className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
              >
                <svg
                  id="note-icon"
